...
elseif (time .ge. 100.0d0 .and. time .le. 100.1d0) then
  ...
  Glustm =1000.0d0
   ...
   Glustm=1000.0d0*exp(-0.255d0*(time-t2glu)) ! Glu in uM unit
end if
...
! Plase comment 426-428 if you are not looking for ischemia
...
! NMDA APV sensitive equations

! APV sensitive Model parameters for 3.0uM Glutamate parameters
