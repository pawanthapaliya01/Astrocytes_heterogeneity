...
% Glutamate mediated NMDA current obtained from experimental data
b01=[120;0.028;0.0067]; % initial guess
v=-80;
%dataInmda= b01(1)*data*b01(2)*v/(1+exp(b01(3)*v));

% Glutamate mediated NMDA current obtained from simulation
