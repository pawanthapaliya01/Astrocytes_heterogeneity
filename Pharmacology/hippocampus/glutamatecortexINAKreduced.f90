...
!write(*,*) INMDAmax
fact1=-INMDAmax/1.50d0*Odap*b1/(1.0d0+exp(b2*vk))*0.210d0!*0.03d0!0.18d0!0.35d0
...
fact2=-Iampamax/1.50d0*Oamp*b1/(1.0d0+exp(b2*vk))*0.210d0!*0.03d0!!0.170d0!*0.05d0
...
fun(17) = kc2c3*ARdap+koc3*Odap-(kc3c2+kc3o)*A2Rdap!      %C3 A2R
